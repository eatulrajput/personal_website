...
export const metadata: Metadata = {
  ...
  description:
    "Dev - Backend Developer and Machine Learning Engineer. Portfolio built in the editorial design style of Wired.com.",
  keywords: [
    "Dev",
  ...
  openGraph: {
    title: "DEV // WIRED PORTFOLIO",
    description:
      "Explore Dev's engineering archives, systems design, and ML research papers.",
